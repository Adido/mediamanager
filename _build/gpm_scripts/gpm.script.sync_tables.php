...
if ($transport->xpdo) {
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $tables = [
                \Sterc\MediaManager\Model\MediamanagerCategories::class,
                \Sterc\MediaManager\Model\MediamanagerTags::class,
                \Sterc\MediaManager\Model\MediamanagerFiles::class,
                \Sterc\MediaManager\Model\MediamanagerDownloads::class,
                \Sterc\MediaManager\Model\MediamanagerFilesCategories::class,
                \Sterc\MediaManager\Model\MediamanagerFilesLicense::class,
                \Sterc\MediaManager\Model\MediamanagerFilesLicenseFile::class,
                \Sterc\MediaManager\Model\MediamanagerFilesTags::class,
                \Sterc\MediaManager\Model\MediamanagerFilesContent::class,
                \Sterc\MediaManager\Model\MediamanagerFilesRelations::class,
                \Sterc\MediaManager\Model\MediamanagerFilesVersions::class,
                \Sterc\MediaManager\Model\MediamanagerFilesMeta::class,
            ];
