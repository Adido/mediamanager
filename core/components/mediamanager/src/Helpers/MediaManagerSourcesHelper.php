...
class MediaManagerSourcesHelper
{
    ...
    {
        $source = $this->mediaManager->modx->getObject(modMediaSource::class, [
    ...
    {
        $query = $this->mediaManager->modx->newQuery(modMediaSource::class);
        $query->leftJoin(modAccessMediaSource::class, 'modAccessMediaSource', 'modAccessMediaSource.target = modMediaSource.id');
        $query->where([
        ...
        $mediaSources = $this->mediaManager->modx->getIterator(modMediaSource::class, $query);
