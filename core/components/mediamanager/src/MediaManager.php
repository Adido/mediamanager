...
namespace Sterc\MediaManager;

use MODX\Revolution\modX;
use Sterc\MediaManager\Helpers\MediaManagerCategoriesHelper;
use Sterc\MediaManager\Helpers\MediaManagerFilesHelper;
use Sterc\MediaManager\Helpers\MediaManagerPermissionsHelper;
use Sterc\MediaManager\Helpers\MediaManagerSourcesHelper;
use Sterc\MediaManager\Helpers\MediaManagerTagsHelper;
use Sterc\MediaManager\Model\MediamanagerFilesContent;

/**
 * Media Manager Main Class
 *
 * @package Sterc\MediaManager
 */
class MediaManager
{
    /**
    ...
    public function saveFileContent($fileId, $resourceId, $tvId = 0)
    {
        ...
        if (!$object) {
            $object = $this->modx->newObject(MediamanagerFilesContent::class, [
                'mediamanager_files_id' => $fileId,
                'site_content_id'       => $resourceId
            ]);
        }
