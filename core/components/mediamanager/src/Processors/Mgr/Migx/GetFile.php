...
namespace Sterc\MediaManager\Processors\Mgr\Migx;
 ...
 * @subpackage processors.mgr.migx
 */
class GetFile extends Processor
{
    ...
    public function initialize()
    {
        ...
        $this->modx->getService('fileHandler', modFileHandler::class, '', ['source' => $this->getProperty('wctx')]);
    ...
    public function process()
    {
        ...
        if (is_numeric($src)) {
            $file = $this->modx->getObject(MediamanagerFiles::class, $src);
